...
const FEATURES = [
  ...
  { icon: Tag01Icon, title: 'Best Prices', note: 'Affordable every day' },
  { icon: Plant01Icon, title: 'Fresh Quality', note: '100% guaranteed' },
];
        ...
        <div className="relative hidden lg:block">
          <div className="relative mx-auto flex h-[420px] w-full max-w-md items-center justify-center rounded-[2rem] brand-gradient text-white shadow-pop">
            <div className="text-center">
              ...
              <p className="mt-4 text-sm text-white/80">On your first order</p>
            </div>
